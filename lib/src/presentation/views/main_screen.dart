        ...
        children: [
          ...
          Align(
              ...
              child: Padding(
                  ...
                  child: Image.asset('assets/images/dash_icon.png', height: 90, width: 90, fit: BoxFit.contain))),
          LandingSection(
            onTap: () {
...
class LandingSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Padding(
                  ...
                  child: Icon(Icons.circle, color: theme.colorScheme.primary, size: 20))
            ])
          ])
        ]),
        SizedBox(
      ...
      Image.asset('assets/images/me.png', height: size.height / 1.5, width: size.width / 3)
    ]);
  }
}
                ...
                child: Stack(children: [
                  FractionalTranslation(
                      ...
                      child: Text(widget.text,
                          style: TextStyle(
                              color: _isHovered ? Colors.black : theme.colorScheme.primary,
                  ...
                  FractionalTranslation(
                      ...
                      child: Text(widget.text,
                          style: TextStyle(
                              color: _isHovered ? Colors.transparent : theme.colorScheme.primary,
                              fontWeight: FontWeight.w600,
                              fontSize: 12.0,
                              letterSpacing: 1.5)))
                ]))));
